...
class TestExtractGitData:
    ...
    def test_extract_git_data_with_start_and_end_dates(self, mock_repo):
        mock_repo.return_value.iter_commits.return_value = [
            Mock(authored_datetime=datetime(2023, 4, 1), hexsha='abc123', author=Mock(name='Test Author'), message='Commit message 1'),
            Mock(authored_datetime=datetime(2023, 4, 2), hexsha='def456', author=Mock(name='Test Author'), message='Commit message 2'),
            Mock(authored_datetime=datetime(2023, 4, 3), hexsha='ghi789', author=Mock(name='Test Author'), message='Commit message 3'),
        ]
